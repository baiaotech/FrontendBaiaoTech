...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#e6e6e7] text-slate-700 border-t border-slate-300/80">
      <div className="mx-auto w-full max-w-5xl px-6 py-12">
        {/* Logo */}
        <div className="flex justify-center">
          <Link href="/" className="inline-flex items-center">
            <Image src={logo} alt="BAIÃO TECH" className="h-9 w-auto" priority />
          </Link>
        </div>

        {/* Tagline */}
        <p className="mt-6 text-center text-[13px] leading-relaxed text-slate-600">
          Baião Tech é o #1 indexador de eventos de tecnologia do Nordeste, antes Coders Ceará,
          agora Baião Tech! ❤️
        </p>
        ...
        <ul className="mt-8 flex flex-wrap items-center justify-center gap-x-6 gap-y-3 text-[13px]">
          <li>
            ...
            >
              ...
              <span className="underline decoration-slate-500/60 underline-offset-2">Instagram</span>
            </Link>
          </li>
          ...
          <li>
            ...
            >
              {/* WhatsApp */}
              <svg className={icon16} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
              ...
              <span className="underline decoration-slate-500/60 underline-offset-2">WhatsApp</span>
            </Link>
          </li>
          ...
          <li>
            ...
            >
              ...
              <span className="underline decoration-slate-500/60 underline-offset-2">YouTube</span>
            </Link>
          </li>
          ...
          <li>
            ...
            >
              ...
              <span className="underline decoration-slate-500/60 underline-offset-2">LinkedIn</span>
            </Link>
          </li>
        </ul>
        ...
        <div className="mt-5 flex flex-wrap items-center justify-center gap-6 text-[13px]">
          ...
          >
            {/* megafone */}
            <svg className={icon16} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
              <path d="M21 8a2 2 0 0 0-2-2h-2.4l-6-3.3A2 2 0 0 0 8 4v12a2 2 0 0 0 2.6 1.8L16.6 14H19a2 2 0 0 0 2-2V8Z"/><path d="M7 10H3v4a3 3 0 0 0 3 3h1"/>
            </svg>
            Indique evento
          </Link>

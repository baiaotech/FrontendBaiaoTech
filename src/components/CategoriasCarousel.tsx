      ...
      <Carousel className="w-full h-auto flex justify-center items-center">
        <CarouselContent className="flex">
          {categorias.map((i) => (
            <CarouselItem
              key={i.id}
              className="w-full h-full flex justify-center items-center md:basis-1/3 lg:basis-1/4 xl:basis-1/8"
            >
              {/* Card dentro do CarouselItem */}
              <div className="w-[180px] h-[160px] bg-[#333] flex flex-col justify-between items-center rounded-2xl p-2">
